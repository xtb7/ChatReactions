package net.xtb7.chatReactions.bstats;/*
 * This org.bstats.bukkit.Metrics class was auto-generated and can be copied into your project if you are
...
public class Metrics {
  ...
  /**
   * Creates a new org.bstats.bukkit.Metrics instance.
   *
  ...
  public static class MetricsBase {
    ...
    /** The version of the org.bstats.bukkit.Metrics class. */
    ...
    public MetricsBase(
      ...
      ScheduledThreadPoolExecutor scheduler =
          new ScheduledThreadPoolExecutor(
              1,
              task -> {
                Thread thread = new Thread(task, "bStats-org.bstats.bukkit.Metrics");
    ...
    private void startSubmitting() {
      ...
      // WARNING: You must not modify and part of this org.bstats.bukkit.Metrics class, including the
    ...
    private void sendData(JsonObjectBuilder.JsonObject data) throws Exception {
      ...
      connection.setRequestProperty("User-Agent", "org.bstats.bukkit.Metrics-Service/1");
    ...
    private void checkRelocation() {
      ...
      if (System.getProperty("bstats.relocatecheck") == null
        ...
        if (MetricsBase.class.getPackage().getName().startsWith(defaultPackage)
          ...
          throw new IllegalStateException("bStats org.bstats.bukkit.Metrics class has not been relocated correctly!");
        }
      }
    }
